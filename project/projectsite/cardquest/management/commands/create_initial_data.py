...
class Command(BaseCommand):
    help = 'Create initial data for the application' #<-- description of the command
    ...
    def create_pokemon_cards(self):
        ...
        card1 = PokemonCard(name="Pikachu", rarity="Rare", hp=60, card_type="Electric", attack="Thunder Shock", description=" A mouselike pokemon that can generate electricity.",
        ...
        card18.save()
        card19.save()
        card20.save()   #<-- save card1 to pokemoncard table
